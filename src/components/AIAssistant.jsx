...
const topicData = {
  main: {
    options: [
      { label: "📦 Where is my order?", value: "order" },
      { label: "🛍️ How to place an order?", value: "place" },
      { label: "🔧 How to get support?", value: "support" },
      { label: "✨ What is RoboMitra?", value: "about" },
    ],
  },
  order: {
    ...
    options: [
      { label: "🗓️ How many days to deliver?", value: "delivery_time" },
      { label: "📍 Can I change delivery address?", value: "change_address" },
      { label: "💬 Talk to a human agent", value: "human_agent" },
  ...
  delivery_time: {
    ...
    options: [
      { label: "📦 Track order status", value: "order" },
      { label: "💬 Talk to a human agent", value: "human_agent" },
      { label: "↩️ Back to main menu", value: "main" },
    ]
  },
  ...
  place: {
    ...
    options: [
      { label: "💰 What are the prices?", value: "pricing" },
      { label: "🎨 Are there custom designs?", value: "customization" },
      { label: "↩️ Back to main menu", value: "main" },
    ]
  },
  pricing: {
  ...
  support: {
    ...
    options: [
      { label: "🔋 Battery / Charging guide", value: "battery_guide" },
      { label: "🛠️ How to reset RoboMitra?", value: "reset_guide" },
      { label: "📧 Direct Email Contact", value: "email_contact" },
      { label: "↩️ Back to main menu", value: "main" },
    ]
  },
  battery_guide: {
  ...
  about: {
    ...
    options: [
      { label: "🛍️ How to place an order?", value: "place" },
      { label: "🔧 Troubleshooting / support?", value: "support" },
      { label: "↩️ Back to main menu", value: "main" },
    ]
  },
  human_agent: {
...
export default function AIAssistant() {
  ...
  const getMatchedTopicValue = (text) => {
    ...
    if (cleanVal.includes("buy") || cleanVal.includes("place") || cleanVal.includes("purchase") || cleanVal.includes("shop")) {
              ...
              <div className="ai-faq-grid">
                {currentOptions.map((opt) => (
                  <button
                    ...
                    onClick={() => handleSelectOption(opt.value, opt.label.substring(3))}
                    disabled={isTyping}
                  >
                    {opt.label}
                  </button>
